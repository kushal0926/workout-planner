    ...
    <tr className="border-b border-border last:border-0">
      <td className="py-3 pr-4">
        <div className="flex items-start gap-3">
          <span className="text-xl text-accent w-5">{index + 1}.</span>
          <div>
            <p className="font-medium leading-relaxed text-cream text-xl">{exercise.name}</p>
            {exercise.notes && (
      ...
      <td className="py-3 px-4 text-center whitespace-nowrap text-xl">
        ...
        <span className="text-cream">{exercise.reps}</span>
      </td>

      <td className="py-3 px-4 text-center">
        <span className="text-muted text-xl">{exercise.rest}</span>
      </td>
      <td className="py-3 px-4 text-center">
        <span
  ...
  return (
    <Card variant="bordered" className="overflow-hidden">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-semibold text-xl text-accent">{schedule.day}</h3>
          <p className="text-xl text-muted font-medium">{schedule.focus}</p>
        </div>
        <div className="flex items-center gap-2 text-xl text-charcol">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-muted text-xs uppercase tracking-wider">
              <th className="text-xl text-left py-2 pr-4 font-medium">Excercise</th>
